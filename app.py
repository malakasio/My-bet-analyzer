...
_DEFAULTS: dict = {
    ...
    "odds_soccer_keys": {},     # populated by Test Connections
    # Checklist
    ...
    if not errors:
        if ta_data is None:
            ...
            errors.append(
                ...
                "(e.g. 'Olympiakos', 'Panathinaikos', 'Juventus', 'Manchester City'). "
                "If unsure, look up the team at api-football.com."
            )
        else:
        ...
        if tb_data is None:
            ...
            errors.append(
                ...
                "Use the exact English official name from API-Football."
            )
        else:
